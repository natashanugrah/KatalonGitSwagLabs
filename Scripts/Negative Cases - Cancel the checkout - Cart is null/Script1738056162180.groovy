...
WebUI.click(findTestObject('Object Repository/katalon_asisst_ai_swagLabs/Page_Swag Labs/input_Cancel_continue'))

// Click the cancel button with a timeout of 20 seconds
WebUI.click(findTestObject('Object Repository/katalon_asisst_ai_swagLabs/Page_Swag Labs/button_Cancel'), FailureHandling.STOP_ON_FAILURE)
