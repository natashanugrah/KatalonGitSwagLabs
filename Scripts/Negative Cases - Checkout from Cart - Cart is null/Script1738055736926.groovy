...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_user-name'), GlobalVariable.Username1)

// Fill the password field with the value from GlobalVariable.Password2
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_password'), GlobalVariable.Password2)
...
WebUI.click(findTestObject('Object Repository/katalon_asisst_ai_swagLabs/Page_Swag Labs/button_Checkout'))

// Fill the first name field with 'testing'
WebUI.setText(findTestObject('Object Repository/katalon_asisst_ai_swagLabs/Page_Swag Labs/input_Checkout Your Information_firstName'), 'testing')

// Fill the last name field with 'sha'
WebUI.setText(findTestObject('Object Repository/katalon_asisst_ai_swagLabs/Page_Swag Labs/input_Checkout Your Information_lastName'), 'sha')

// Fill the postal code field with 'KT21219A'
WebUI.setText(findTestObject('Object Repository/katalon_asisst_ai_swagLabs/Page_Swag Labs/input_Checkout Your Information_postalCode'), 'KT21219A')
...
WebUI.click(findTestObject('Object Repository/katalon_asisst_ai_swagLabs/Page_Swag Labs/button_Finish'))

// Verify that the checkout complete message is displayed with a timeout of 30 seconds
WebUI.verifyElementPresent(findTestObject('Object Repository/katalon_asisst_ai_swagLabs/Page_Swag Labs/div_Checkout Complete'), 30)
