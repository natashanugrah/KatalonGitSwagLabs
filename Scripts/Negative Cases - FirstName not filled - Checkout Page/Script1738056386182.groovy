...
WebUI.setText(findTestObject('katalon_asisst_ai_swagLabs/Page_Swag Labs/input_Checkout Your Information_postalCode'), 'KT1218')
 ...
 *
 **/
// Find and call the 'Test Cases/StudioAssist/Checkout Information' with the provided username and password
...
// Fill the last name input field with the value 'sha'
WebUI.setText(findTestObject('katalon_asisst_ai_swagLabs/Page_Swag Labs/input_Checkout Your Information_lastName'), 'sha')

// Fill the postal code input field with the value 'KT1218'
WebUI.setText(findTestObject('katalon_asisst_ai_swagLabs/Page_Swag Labs/input_Checkout Your Information_postalCode'), 'KT1218')
