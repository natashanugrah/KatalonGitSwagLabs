...
WebUI.scrollToElement(findTestObject('Page_Swag Labs/a_LinkedIn'), 0)

WebUI.click(findTestObject('Page_Swag Labs/a_LinkedIn'))

WebUI.switchToWindowUrl('https://www.linkedin.com/company/sauce-labs/')

WebUI.verifyElementPresent(findTestObject('Page_Sauce Labs  LinkedIn/h2_LinkedIn'), 0)
