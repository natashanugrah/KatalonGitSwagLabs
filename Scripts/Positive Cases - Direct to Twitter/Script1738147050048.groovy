...
WebUI.scrollToElement(findTestObject('Page_Swag Labs/a_Twitter'), 0)

WebUI.click(findTestObject('Page_Swag Labs/a_Twitter'))

WebUI.switchToWindowUrl('https://x.com/saucelabs?mx=2')

WebUI.verifyElementPresent(findTestObject('Page_Sauce Labs (saucelabs)  X/div_Sauce Labssaucelabs_Twitter'), 0)
