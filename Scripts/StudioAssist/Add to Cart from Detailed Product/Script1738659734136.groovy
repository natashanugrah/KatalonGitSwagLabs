...
/**
UseCase 2: This use case is generating the code by seperating the objects and variables with actions
...
// Verify successfully redirect to main home with div cart element is exist
